import torch
from model.backbone import resnet,DenseNet
import numpy as np
...
class parsingNet(torch.nn.Module):
    def __init__(self, pretrained=True, backbone='121', num_grid_row = None, num_cls_row = None, num_grid_col = None, num_cls_col = None, num_lane_on_row = None, num_lane_on_col = None, use_aux=False,input_height = None, input_width = None, fc_norm = False):
        ...
        self.model = DenseNet(backbone, pretrained=pretrained)
        ...
        self.pool = torch.nn.Conv2d(1024,8,1) if backbone in ['121','18', '34fca'] else torch.nn.Conv2d(2048,8,1)
        # if self.use_aux:
